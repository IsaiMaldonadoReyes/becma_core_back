...
class RptPresupuestoController extends Controller
{
     ...
     */
     ...
     public function datosGrafica5(Request $request)
    {
        ...
        try {
            ...
            // 1. Crear la tabla temporal (VentasPivot)
            DB::statement("
            ...
            $empresa = $datosEmpresa->base_datos;
            ...
            $query = "
                ...
                SET @query = 'INSERT INTO VentasPivot (marca, tipo, ' + @cols + ')
                              ...
                              FROM (
                                  ...
                                  FROM [$empresa].dbo.admDocumentos AS doc
                                  INNER JOIN [$empresa].dbo.admMovimientos AS mov ON doc.CIDDOCUMENTO = mov.CIDDOCUMENTO
                                  INNER JOIN [$empresa].dbo.admProductos AS pro ON mov.CIDPRODUCTO = pro.CIDPRODUCTO
                                  INNER JOIN [$empresa].dbo.admClasificacionesValores AS claVal 
                                      ON pro.CIDVALORCLASIFICACION1 = claVal.CIDVALORCLASIFICACION
                                  INNER JOIN [$empresa].dbo.admConceptos AS con 
            ...
            // 4. Obtener los resultados combinados
