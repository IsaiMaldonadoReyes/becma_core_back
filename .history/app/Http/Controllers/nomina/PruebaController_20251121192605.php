...
class PruebaController extends Controller
{
    ...
    public function exportPrenomina(Request $request)
    {
        ...
        dd([
            'xlColumnaInicioNominaIngresosReales' => $xlColumnaInicioNominaIngresosReales,
            'xlColumnaFinNominaIngresosReales' => $xlColumnaFinNominaIngresosReales,
            '$xlColumnaInicioPercepciones ' => $xlColumnaInicioPercepciones ,
            '$xlColumnaFinPercepciones' => $xlColumnaFinPercepciones,
            '$xlColumnaInicioExcedente' => $xlColumnaInicioExcedente,
            '$xlColumnaFinExcedente' => $xlColumnaFinExcedente,
            '$xlColumnaInicioProvisiones' => $xlColumnaInicioProvisiones,
            '$xlColumnaFinProvisiones' => $xlColumnaFinProvisiones,
            '$xlColumnaInicioCargaSocial' => $xlColumnaInicioCargaSocial,
            '$xlColumnaFinCargaSocial' => $xlColumnaFinCargaSocial,
        ]);
        ...
        $sheet->fromArray($xlMatriz, null, "A{$xlFilaInicioDatos}");
        ...
        $this->columnRangeGroup($sheet, 'I', \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaFinNominaIngresosReales));

        // Agrupar sección percepciones
        $this->columnRangeGroup($sheet, \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaInicioPercepciones), \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaFinPercepciones));

        // Agrupar sección Excedente
        $this->columnRangeGroup($sheet, \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaInicioExcedente), \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaFinExcedente));

        // Agrupar sección Provisiones
        $this->columnRangeGroup($sheet, \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaInicioProvisiones), \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaFinProvisiones));

        // Agrupar sección CargaSocial
        $this->columnRangeGroup($sheet, \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaInicioCargaSocial), \PhpOffice\PhpSpreadsheet\Cell\Coordinate::stringFromColumnIndex($xlColumnaFinCargaSocial));
