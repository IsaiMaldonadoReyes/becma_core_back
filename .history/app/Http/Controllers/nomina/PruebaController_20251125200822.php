...
class PruebaController extends Controller
{
    ...
    public function exportPrenomina(Request $request)
    {
        ...
        $this->asignarFormatoMonto($sheet, 'I:I');
        $this->asignarFormatoMonto($sheet, 'J:J');
        $this->asignarFormatoMonto($sheet, 'Q:Q');
    ...
    public function asignarFormatoMonto($sheet, string $rango)
    {
        ...
        if (strpos($rango, ':') !== false) {
            ...
            $endIndex   = \PhpOffice\PhpSpreadsheet\Cell\Coordinate::columnIndexFromString($colFin);
    ...
    public function asignarFormatoCantidad($sheet, string $rango)
    {
        ...
        // Extraer la columna real (ej. de "I:I" → "I")
        if (strpos($rango, ':') !== false) {
            [$col] = explode(':', $rango);
        } else {
            $col = $rango;
        ...
        // AutoSize SOLO acepta una letra de columna
        $sheet->getColumnDimension($col)->setAutoSize(true);
    }
