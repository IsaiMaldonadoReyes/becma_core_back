...
class PruebaController extends Controller
{
    ...
    public function exportPrenomina(Request $request)
    {
        ...
        $jsonPathPercepciones  = storage_path('app/public/plantillas/data/03percepcione.json');
        ...
        dd([
            ...
            'raw' => file_get_contents($jsonPathPercepciones),
        ...
        // Insertar columnas dinámicas por que las que están fijas que son 17 ya no es necesario agregarlas
        $sheet->insertNewColumnBefore(Coordinate::stringFromColumnIndex($xlColumnaFinDetalleEmpleado), $xlTotalColumnasDinamicas);
