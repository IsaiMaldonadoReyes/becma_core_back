...
class PruebaController extends Controller
{
    ...
    public function exportPrenomina(Request $request)
    {
        ...
        $this->columnRangeGroup($sheet, Coordinate::stringFromColumnIndex($xlColumnaInicioPercepciones), Coordinate::stringFromColumnIndex($xlColumnaFinPercepciones));

        // Agrupar sección Excedente
        $this->columnRangeGroup($sheet, Coordinate::stringFromColumnIndex($xlColumnaInicioExcedente), Coordinate::stringFromColumnIndex($xlColumnaFinExcedente));

        // Agrupar sección Provisiones
        $this->columnRangeGroup($sheet, Coordinate::stringFromColumnIndex($xlColumnaInicioProvisiones), Coordinate::stringFromColumnIndex($xlColumnaFinProvisiones));

        // Agrupar sección CargaSocial
        $this->columnRangeGroup($sheet, Coordinate::stringFromColumnIndex($xlColumnaInicioCargaSocial), Coordinate::stringFromColumnIndex($xlColumnaFinCargaSocial));
