...
class PruebaController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        $this->rowRangeGroup($sheet, 1, 10);  // Agrupa filas 5–12
    ...
    {
        // Configurar el outline para agrupadores verticales (filas)
        $sheet->getOutline()->setSummaryBelow(true); // Botón abajo del grupo
