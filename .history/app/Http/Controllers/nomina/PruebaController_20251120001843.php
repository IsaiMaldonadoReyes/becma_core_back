...
class PruebaController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        // 3. Fila base
        $filaBase = 11;   // la fila que contiene el formato
        $filaInicio = 11; // aquí empieza el primer empleado
    ...
    function copyRow($sheet, int $sourceRow, int $targetRow)
    {
        ...
        // 1. Copiar estilos
        $sourceRange = "A{$sourceRow}:{$highestColumn}{$sourceRow}";
        $targetRange = "A{$targetRow}:{$highestColumn}{$targetRow}";
