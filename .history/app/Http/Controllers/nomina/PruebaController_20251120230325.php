...
class PruebaController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        $resultDetalleEmpleado = json_decode(file_get_contents($jsonFijosPath), true);
        $resultNominaIngresosReales = json_decode(file_get_contents($jsonFijosPath), true);
        $resultPercepciones = json_decode(file_get_contents($jsonFijosPath), true);
        $resultExcedente = json_decode(file_get_contents($jsonFijosPath), true);
        $resultProvisiones = json_decode(file_get_contents($jsonFijosPath), true);
        $resultCargaSocial = json_decode(file_get_contents($jsonFijosPath), true);
