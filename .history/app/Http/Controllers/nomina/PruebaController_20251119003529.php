...
class PruebaController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        $this->groupRows($sheet, 5, 12); // Agrupa filas 5–12
    ...
    function groupRows($sheet, int $startRow, int $endRow, int $level = 1, bool $collapsed = true)
    {
        // Configuración general del outline
        $sheet->getOutline()->setSummaryBelow(true); // Botón de agrupador abajo del bloque
