...
class PruebaController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        // Inicio y fin de las columnas correspondientes a cada sección para merge y agrupadores
        $xlColumnaInicioDetalleEmpleado = 1; // lo pongo fijo por que estás columnas están fijas en el formato 
        $xlColumnaFinDetalleEmpleado = 17; // lo pongo fijo por que estás columnas están fijas en el formato 
        ...
        $xlColumnaFinPercepciones = count($indicesPercepciones) + $xlColumnaInicioNominaIngresosReales;;
