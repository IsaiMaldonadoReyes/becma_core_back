...
class PruebaController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        // Para merges y agrupadores
        $xlColumnaInicioDetalleEmpleado = 'A';
        $xlColumnaFinDetalleEmpleado = 'Q';

        $xlColumnaInicioNominaIngresosReales = '';
        $xlColumnaFinNominaIngresosReales = '';

        $xlColumnaInicioPercepciones = '';
        $xlColumnaFinPercepciones = '';

        $xlColumnaInicioExcedente = '';
        $xlColumnaFinExcedente = '';

        $xlColumnaInicioProvisiones = '';
        $xlColumnaFinProvisiones = '';
        ...
        // Obtener data
        $dataDetalleEmpleado = json_decode(file_get_contents($jsonFijosPath), true);
        $dataNominaIngresosReales = json_decode(file_get_contents($jsonFijosPath), true);
        $dataPercepciones = json_decode(file_get_contents($jsonFijosPath), true);
        $dataExcedente = json_decode(file_get_contents($jsonFijosPath), true);
        $dataProvisiones = json_decode(file_get_contents($jsonFijosPath), true);
        $dataCargaSocial = json_decode(file_get_contents($jsonFijosPath), true);
        ...
        $indicesExcedente = array_keys($dataExcedente[0]);
        $indicesProvisiones = array_keys($dataProvisiones[0]);
        $indicesCargaSocial = array_keys($dataCargaSocial[0]);

        // Insertar columnas dinámicas
        // las columnas de detalleEmpleado son fijas
