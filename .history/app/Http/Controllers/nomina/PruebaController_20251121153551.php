...
class PruebaController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        $xlColumnaFinExcedente = count($indicesExcedente) + $xlColumnaInicioExcedente;
        ...
        // Total de columnas dinámicas
        $xlTotalColumnas = $xlTotalColumnas - $xlColumnaFinDetalleEmpleado;

        // Insertar columnas dinámicas
        $sheet->insertNewColumnBefore($startDynamicColumn, $xlTotalColumnas);
