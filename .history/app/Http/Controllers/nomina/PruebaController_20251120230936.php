...
class PruebaController extends Controller
{
    public function exportExcel(Request $request)
    {
        ...
        // Índices de las columnas de los resultados SQL
        $indicesDetalleEmpleado = array_keys($empleadosFijos[0]);
        $indicesNominaIngresosReales = array_keys($empleadosFijos[0]);
        $indicesPercepciones = array_keys($empleadosFijos[0]);
        $indicesExcedente = array_keys($empleadosFijos[0]);
        $indicesProvisiones = array_keys($empleadosFijos[0]);
        $indicesCargaSocial = array_keys($empleadosFijos[0]);
