...
class IncidenciasSaver
{
    ...
    public function guardarDetalleExcedente($sheet, $row, $incidenciaId, $nombreHoja, $idEsquema, $idEsquemaCombinacion)
    {
        $codigo = trim($sheet->getCell("A{$row}")->getValue());
        $empleado = NominaGapeEmpleado::where('codigoempleado', $codigo)->first();
