        ...
        try {
            ...
            $sql = "
                ...
                SELECT
                    ...
                    , (periodo.diasdepago + ISNULL(ngid.cantidad_dias_retroactivos, 0) - ISNULL(ngid.cantidad_incapacidad, 0) - ISNULL(ngid.cantidad_faltas, 0)) AS diasPagados
		            , ISNULL((emp.ccampoextranumerico2 * ((periodo.diasdepago + ISNULL(ngid.cantidad_dias_retroactivos, 0) - ISNULL(ngid.cantidad_incapacidad, 0) - ISNULL(ngid.cantidad_faltas, 0)))), 0) AS sueldo
                FROM nom10001 emp
                    ...
                    LEFT JOIN [becma-core2].dbo.nomina_gape_incidencia_detalle AS ngid
        ...
        try {
            ...
            $sql = "
                ...
                MovimientosSuma AS (
                    SELECT
                        emp.codigoempleado,
                        (emp.ccampoextranumerico2 * (periodo.diasdepago + ISNULL(ngid.cantidad_dias_retroactivos, 0) - ISNULL(ngid.cantidad_incapacidad, 0) - ISNULL(ngid.cantidad_faltas, 0))) AS sueldo,
                        pdo.descripcion,
                    ...
                    LEFT JOIN Movimientos pdo
                        ON empPeriodo.cidperiodo = pdo.idperiodo
							AND emp.idempleado = pdo.idempleado
					LEFT JOIN [becma-core2].dbo.nomina_gape_incidencia AS ngi
						ON empPeriodo.cidperiodo = ngi.id_periodo
					LEFT JOIN [becma-core2].dbo.nomina_gape_incidencia_detalle AS ngid
						ON ngi.id = ngid.id_nomina_gape_incidencia
						AND empPeriodo.idempleado = ngid.id_empleado
						AND ngi.id_nomina_gape_empresa = @idNominaGapeEmpresa
